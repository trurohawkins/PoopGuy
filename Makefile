...
libFormGlfw.a: FormGlfw.o Form.o helper.o glfwMain.o Shaders.o Input.o Anim.o Text.o
	ar rs libFormGlfw.a FormGlfw.o Form.o helper.o glfwMain.o Shaders.o Input.o Anim.o Text.o 

FormGlfw.o: $(GF)FormGlfw.c $(GF)FormGlfw.h $(GF)Player.c $(GF)Player.h $(GF)poopPlayer.c $(GF)poopPlayer.h $(GF)PlayerManager.h $(GF)PlayerManager.c $(AD)Cloud.c $(AD)Cloud.h $(GF)DrawWorld.c $(GF)DrawWorld.h $(GF)Camera.c $(GF)Camera.h $(GF)god.h $(GF)god.c
	$(CC) $(GF)FormGlfw.c
...
libglfw.a: glfwMain.o Shaders.o Input.o Anim.o Text.o
	ar rs libglfw.a glfwMain.o Shaders.o Input.o Anim.o Text.o
