...
void resizeTileSet(TileSet *t, int newSizeX, int newSizeY) {
	resizeDrawScreen(t->trans, newSizeX, newSizeY, false);
	resizeDrawScreen(t->rot, newSizeX, newSizeY, true);
	resizeDrawScreen(t->color, newSizeX, newSizeY, true);
	resizeDrawScreen(t->texture, newSizeX, newSizeY, true);
}
